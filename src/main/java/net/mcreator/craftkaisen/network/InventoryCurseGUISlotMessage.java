...
public class InventoryCurseGUISlotMessage {
	...
	public InventoryCurseGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(InventoryCurseGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(InventoryCurseGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
