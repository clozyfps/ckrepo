...
public class SelfVowGUIButtonMessage {
	...
	public SelfVowGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(SelfVowGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(SelfVowGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
