...
public class MahitoEntity extends Monster {
	...
	public static void init() {
		SpawnPlacements.register(CraftKaisenModEntities.MAHITO.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
