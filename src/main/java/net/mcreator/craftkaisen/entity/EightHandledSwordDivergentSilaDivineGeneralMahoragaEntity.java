...
public class EightHandledSwordDivergentSilaDivineGeneralMahoragaEntity extends TamableAnimal {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		EightHandledSwordDivergentSilaDivineGeneralMahoragaEntity retval = CraftKaisenModEntities.EIGHT_HANDLED_SWORD_DIVERGENT_SILA_DIVINE_GENERAL_MAHORAGA.get().create(serverWorld);
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.MAX_HEALTH, 840);
