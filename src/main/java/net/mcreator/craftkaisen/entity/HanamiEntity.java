...
import net.mcreator.craftkaisen.procedures.HanamiOnInitialEntitySpawnProcedure;
...
public class HanamiEntity extends Monster {
	public HanamiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CraftKaisenModEntities.HANAMI.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(CraftKaisenModEntities.HANAMI.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
