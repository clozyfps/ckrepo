...
public class JinichiZeninEntity extends Monster {
	public JinichiZeninEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CraftKaisenModEntities.JINICHI_ZENIN.get(), world);
	}

	public JinichiZeninEntity(EntityType<JinichiZeninEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
