...
import net.mcreator.craftkaisen.procedures.MegumiFushiguroOnEntityTickUpdateProcedure;
import net.mcreator.craftkaisen.procedures.MegumiFushiguroEntityDiesProcedure;
...
public class MegumiFushiguroEntity extends Monster {
	...
	public void die(DamageSource source) {
		super.die(source);
		MegumiFushiguroEntityDiesProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}

	@Override
	public void baseTick() {
		super.baseTick();
		MegumiFushiguroOnEntityTickUpdateProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}

	public static void init() {
		SpawnPlacements.register(CraftKaisenModEntities.MEGUMI_FUSHIGURO.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
