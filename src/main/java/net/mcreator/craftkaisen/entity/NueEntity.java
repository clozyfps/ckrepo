...
public class NueEntity extends TamableAnimal implements GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(NueEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(NueEntity.class, EntityDataSerializers.STRING);
	...
	public NueEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CraftKaisenModEntities.NUE.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "nuetexture");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new FollowOwnerGoal(this, 1, (float) 25, (float) 20, false));
	...
	public void baseTick() {
		super.baseTick();
		NueOnEntityTickUpdateProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		NueEntity retval = CraftKaisenModEntities.NUE.get().create(serverWorld);
