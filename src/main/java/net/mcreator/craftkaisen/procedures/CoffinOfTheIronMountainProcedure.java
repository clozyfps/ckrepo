...
public class CoffinOfTheIronMountainProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof ServerLevel _serverworld) {
			...
			if (template != null) {
				template.placeInWorld(_serverworld, BlockPos.containing(x - 22, y, z - 22), BlockPos.containing(x - 22, y, z - 22), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false),
				...
				CraftKaisenMod.queueServerWork(3, () -> {
					...
					CraftKaisenMod.queueServerWork(3, () -> {
						if (world instanceof ServerLevel _serverworld) {
							...
							if (template != null) {
								template.placeInWorld(_serverworld, BlockPos.containing(x - 22, y, z - 22), BlockPos.containing(x - 22, y, z - 22),
