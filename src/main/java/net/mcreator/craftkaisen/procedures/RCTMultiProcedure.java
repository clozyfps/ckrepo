...
public class RCTMultiProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (entity instanceof Player) {
			if (sourceentity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(CraftKaisenModMobEffects.RCT.get()) && sourceentity instanceof ServerPlayer _plr2 && _plr2.level instanceof ServerLevel
