...
public class SlamProcedureProcedure {
		...
		CraftKaisenMod.queueServerWork(20, () -> {
			...
			CraftKaisenMod.queueServerWork(10, () -> {
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.EXPLOSION_EMITTER, x, y, z, 5, 3, 1, 3, 0);
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.POOF, x, y, z, 10, 3, 1, 3, 0);
