...
public class ModelRugbyFieldCurse<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_arm_1 = partdefinition.addOrReplaceChild("left_arm_1",
				CubeListBuilder.create().texOffs(33, 75).addBox(1.0174F, -2.0F, -4.7757F, 4.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(95, 50).addBox(2.0174F, -1.0F, -9.7757F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition left_arm_3 = partdefinition.addOrReplaceChild("left_arm_3",
				CubeListBuilder.create().texOffs(56, 43).addBox(1.0174F, -2.0F, -4.7757F, 4.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(47, 85).addBox(2.0174F, -1.0F, -9.7757F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_arm_1 = partdefinition.addOrReplaceChild("right_arm_1", CubeListBuilder.create().texOffs(33, 75).mirror().addBox(-5.0174F, -2.0F, -4.7757F, 4.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(95, 50)
				.mirror().addBox(-4.0174F, -1.0F, -9.7757F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-7.9826F, 23.0F, -18.0101F));
		...
		PartDefinition cube_r36 = right_arm_1.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-2.0F, -5.5F, -2.5F, 4.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-3.0174F, -12.0F, 3.2601F, 0.48F, 0.0F, 0.0F));
		PartDefinition right_arm_2 = partdefinition.addOrReplaceChild("right_arm_2", CubeListBuilder.create().texOffs(33, 75).mirror().addBox(-5.0174F, -2.0F, -4.7757F, 4.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(95, 50)
				.mirror().addBox(-4.0174F, -1.0F, -9.7757F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-7.9826F, 23.0F, -3.0101F));
		...
		PartDefinition cube_r41 = right_arm_2.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-2.0F, -5.5F, -2.5F, 4.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-3.0174F, -12.0F, 3.2601F, 0.48F, 0.0F, 0.0F));
		PartDefinition right_arm_3 = partdefinition.addOrReplaceChild("right_arm_3", CubeListBuilder.create().texOffs(56, 43).mirror().addBox(-5.0174F, -2.0F, -4.7757F, 4.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(47, 85)
				.mirror().addBox(-4.0174F, -1.0F, -9.7757F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-5.2326F, 23.0F, 13.9899F));
