...
public class MoveGuiScreen extends AbstractContainerScreen<MoveGuiMenu> {
	...
	public void init() {
		super.init();
		button_1 = Button.builder(Component.translatable("gui.craft_kaisen.move_gui.button_1"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 125, this.topPos + 7, 30, 20).build();
		guistate.put("button:button_1", button_1);
		this.addRenderableWidget(button_1);
		button_2 = Button.builder(Component.translatable("gui.craft_kaisen.move_gui.button_2"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 125, this.topPos + 34, 30, 20).build();
		guistate.put("button:button_2", button_2);
		this.addRenderableWidget(button_2);
		button_3 = Button.builder(Component.translatable("gui.craft_kaisen.move_gui.button_3"), e -> {
			if (true) {
		...
		button_4 = Button.builder(Component.translatable("gui.craft_kaisen.move_gui.button_4"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 125, this.topPos + 87, 30, 20).build();
		guistate.put("button:button_4", button_4);
		this.addRenderableWidget(button_4);
		button_5 = Button.builder(Component.translatable("gui.craft_kaisen.move_gui.button_5"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 125, this.topPos + 115, 30, 20).build();
		guistate.put("button:button_5", button_5);
		this.addRenderableWidget(button_5);
		button_6 = Button.builder(Component.translatable("gui.craft_kaisen.move_gui.button_6"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 125, this.topPos + 142, 30, 20).build();
		guistate.put("button:button_6", button_6);
		this.addRenderableWidget(button_6);
		button_unlock = Button.builder(Component.translatable("gui.craft_kaisen.move_gui.button_unlock"), e -> {
		...
		}).bounds(this.leftPos + 35, this.topPos + 115, 56, 20).build(builder -> new Button(builder) {
			@Override
		...
		button_empty = Button.builder(Component.translatable("gui.craft_kaisen.move_gui.button_empty"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 107, this.topPos + 115, 9, 20).build();
		guistate.put("button:button_empty", button_empty);
		this.addRenderableWidget(button_empty);
		button_empty1 = Button.builder(Component.translatable("gui.craft_kaisen.move_gui.button_empty1"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 8, this.topPos + 115, 9, 20).build();
		guistate.put("button:button_empty1", button_empty1);
		this.addRenderableWidget(button_empty1);
		button_empty2 = Button.builder(Component.translatable("gui.craft_kaisen.move_gui.button_empty2"), e -> {
			if (true) {
		...
		button_empty3 = Button.builder(Component.translatable("gui.craft_kaisen.move_gui.button_empty3"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 111, this.topPos + 5, 9, 20).build();
