...
public class MainMenuScreen extends AbstractContainerScreen<MainMenuMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 144 && mouseX < leftPos + 167 && mouseY > topPos + 7 && mouseY < topPos + 20)
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		if (ReturnHumanProcedure.execute(entity))
			this.font.draw(poseStack, Component.translatable("gui.craft_kaisen.main_menu.label_race_human"), -163, 75, -16724788);
		this.font.draw(poseStack,

				ReturnSkillpointsProcedure.execute(entity), -113, -64, -1);
		if (ReturnCursedSpiritProcedure.execute(entity))
			this.font.draw(poseStack, Component.translatable("gui.craft_kaisen.main_menu.label_curse"), -163, 75, -11005165);
		this.font.draw(poseStack,

				ReturnExpDisplayProcedure.execute(entity), -113, -28, -1);
		this.font.draw(poseStack,

				ReturnRepProcedure.execute(entity), -113, 54, -1);
		this.font.draw(poseStack,

				ReturnAffiliationProcedure.execute(entity), -113, 36, -1);
		this.font.draw(poseStack,

				ReturnLevelProcedure.execute(entity), -113, -46, -1);
		this.font.draw(poseStack,

				ReturnSpecialProcedure.execute(entity), -113, -10, -1);
		this.font.draw(poseStack,

				ReturnStrengthProcedure.execute(entity), 33, -64, -1);
		this.font.draw(poseStack,

				ReturnHealthProcedure.execute(entity), 33, -46, -1);
		this.font.draw(poseStack,

				ReturnCursedEnergyProcedure.execute(entity), 33, -9, -1);
		this.font.draw(poseStack,

				ReturnEnergyControlProcedure.execute(entity), 33, -28, -1);
		this.font.draw(poseStack,

				ReturnSpeedProcedure.execute(entity), 33, 8, -1);
		this.font.draw(poseStack,

				ReturnPerkProcedure.execute(entity), -113, 8, -1);
		this.font.draw(poseStack,

				DisplayYenProcedure.execute(entity), -113, 71, -1);
		this.font.draw(poseStack,

				DisplayTechniqueProcedure.execute(entity), -113, -82, -1);
	}
	...
	public void init() {
		...
		}).bounds(this.leftPos + 107, this.topPos + 63, 61, 20).build();
		guistate.put("button:button_mastery", button_mastery);
		this.addRenderableWidget(button_mastery);
		imagebutton_smallbutton1png = new ImageButton(this.leftPos + 143, this.topPos + -66, 25, 15, 0, 0, 15, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_smallbutton1png.png"), 25, 30, e -> {
			if (true) {
		...
		imagebutton_smallbutton1png1 = new ImageButton(this.leftPos + 143, this.topPos + -48, 25, 15, 0, 0, 15, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_smallbutton1png1.png"), 25, 30, e -> {
			if (true) {
		...
		imagebutton_smallbutton1png3 = new ImageButton(this.leftPos + 143, this.topPos + -30, 25, 15, 0, 0, 15, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_smallbutton1png3.png"), 25, 30, e -> {
			if (true) {
		...
		imagebutton_smallbutton1png2 = new ImageButton(this.leftPos + 143, this.topPos + -12, 25, 15, 0, 0, 15, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_smallbutton1png2.png"), 25, 30, e -> {
			if (true) {
		...
		imagebutton_smallbutton1png4 = new ImageButton(this.leftPos + 143, this.topPos + 6, 25, 15, 0, 0, 15, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_smallbutton1png4.png"), 25, 30, e -> {
			if (true) {
