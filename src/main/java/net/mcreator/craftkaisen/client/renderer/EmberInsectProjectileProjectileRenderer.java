...
public class EmberInsectProjectileProjectileRenderer extends EntityRenderer<EmberInsectProjectileProjectileEntity> {
	...
	@Override
	public void render(EmberInsectProjectileProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(EmberInsectProjectileProjectileEntity entity) {
		return texture;
	}
}
