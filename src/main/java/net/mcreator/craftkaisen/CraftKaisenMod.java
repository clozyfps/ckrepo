...
@Mod("craft_kaisen")
public class CraftKaisenMod {
	public static final Logger LOGGER = LogManager.getLogger(CraftKaisenMod.class);
	public static final String MODID = "craft_kaisen";

	public CraftKaisenMod() {
